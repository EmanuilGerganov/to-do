...
var eu = class {
  constructor(t2, e, n, s, i, r, o, u) {
    this.Hs = t2, this.vo = n, this.Vo = s, this.So = i, this.authCredentialsProvider = r, this.appCheckCredentialsProvider = o, this.listener = u, this.state = 0, this.Do = 0, this.Co = null, this.xo = null, this.stream = null, this.No = new tu(t2, e);
  }
  ko() {
  ...
  async close(t2, e) {
    this.Uo(), this.qo(), this.No.cancel(), this.Do++, 4 !== t2 ? this.No.reset() : e && e.code === B2.RESOURCE_EXHAUSTED ? (x2(e.toString()), x2("Using maximum backoff delay to prevent overloading the backend."), this.No.Ao()) : e && e.code === B2.UNAUTHENTICATED && 3 !== this.state && (this.authCredentialsProvider.invalidateToken(), this.appCheckCredentialsProvider.invalidateToken()), null !== this.stream && (this.Ko(), this.stream.close(), this.stream = null), this.state = t2, await this.listener.Zr(e);
  }
  Ko() {
  }
  auth() {
  ...
  Qo(t2, e) {
    ...
    this.stream = this.Wo(t2, e), this.stream.Yr(() => {
      n(() => (this.state = 2, this.xo = this.Hs.enqueueAfterDelay(this.Vo, 1e4, () => (this.Oo() && (this.state = 3), Promise.resolve())), this.listener.Yr()));
    }), this.stream.Zr((t3) => {
      n(() => this.jo(t3));
  ...
  Go(t2) {
    return (e) => {
      this.Hs.enqueueAndForget(() => this.Do === t2 ? e() : (C2("PersistentStream", "stream callback skipped by getCloseGuardedDispatcher."), Promise.resolve()));
    };
  }
};
...
var su = class extends eu {
  constructor(t2, e, n, s, i, r) {
    super(t2, "write_stream_connection_backoff", "write_stream_idle", "health_check_timeout", e, n, s, r), this.It = i, this.Yo = false;
  }
  get Xo() {
    return this.Yo;
  }
  ...
  onMessage(t2) {
    if (M2(!!t2.streamToken), this.lastStreamToken = t2.streamToken, this.Yo) {
      this.No.reset();
      const e = Qs(t2.writeResults, t2.commitTime), n = Ds(t2.commitTime);
      return this.listener.tu(n, e);
    }
    return M2(!t2.writeResults || 0 === t2.writeResults.length), this.Yo = true, this.listener.eu();
  }
  nu() {
    const t2 = {};
...
var iu = class extends class {
  ...
  constructor(t2, e, n, s) {
    super(), this.authCredentials = t2, this.appCheckCredentials = e, this.So = n, this.It = s, this.su = false;
  }
  iu() {
    if (this.su)
  ...
  ao(t2, e, n) {
    return this.iu(), Promise.all([this.authCredentials.getToken(), this.appCheckCredentials.getToken()]).then(([s, i]) => this.So.ao(t2, e, n, s, i)).catch((t3) => {
  ...
  _o(t2, e, n, s) {
    return this.iu(), Promise.all([this.authCredentials.getToken(), this.appCheckCredentials.getToken()]).then(([i, r]) => this.So._o(t2, e, n, i, r, s)).catch((t3) => {
      throw "FirebaseError" === t3.name ? (t3.code === B2.UNAUTHENTICATED && (this.authCredentials.invalidateToken(), this.appCheckCredentials.invalidateToken()), t3) : new L2(B2.UNKNOWN, t3.toString());
    });
  }
  terminate() {
...
This typically indicates that your device does not have a healthy Internet connection at the moment. The client will operate in offline mode until it is able to successfully connect to the backend.`;
    this.uu ? (x2(e), this.uu = false) : C2("OnlineStateTracker", e);
  }
  fu() {
...
var uu = class {
  constructor(t2, e, n, s, i) {
    this.localStore = t2, this.datastore = e, this.asyncQueue = n, this.remoteSyncer = {}, this.du = [], this._u = /* @__PURE__ */ new Map(), this.wu = /* @__PURE__ */ new Set(), this.mu = [], this.gu = i, this.gu.qr((t3) => {
...
function hu(t2, e) {
  const n = $(t2);
  n._u.has(e.targetId) || (n._u.set(e.targetId, e), wu(n) ? _u(n) : ku(n).Oo() && fu(n, e));
}
function lu(t2, e) {
  const n = $(t2), s = ku(n);
  n._u.delete(e), s.Oo() && du(n, e), 0 === n._u.size && (s.Oo() ? s.$o() : mu(n) && n.yu.set("Unknown"));
}
function fu(t2, e) {
...
async function Iu(t2, e, n) {
  ...
  else if (e instanceof gs ? t2.pu.Gt(e) : e instanceof ys ? t2.pu.Yt(e) : t2.pu.Wt(e), !n.isEqual(st.min()))
    try {
      const e2 = await Ro(t2.localStore);
      n.compareTo(e2) >= 0 && await function(t3, e3) {
        const n2 = t3.pu.te(e3);
        return n2.targetChanges.forEach((n3, s) => {
          ...
          if (!n3)
            return;
          t3._u.set(e4, n3.withResumeToken(Wt.EMPTY_BYTE_STRING, n3.snapshotVersion)), du(t3, e4);
...
async function Tu(t2, e, n) {
  if (!Vt(e))
    throw e;
  t2.wu.add(1), await au(t2), t2.yu.set("Offline"), n || (n = () => Ro(t2.localStore)), t2.asyncQueue.enqueueRetryable(async () => {
    C2("RemoteStore", "Retrying IndexedDB access"), await n(), t2.wu.delete(1), await cu(t2);
  });
}
function Eu(t2, e) {
...
async function Du(t2, e, n) {
  const s = t2.du.shift(), i = Oi.from(s, e, n);
...
async function Cu(t2, e) {
  e && Ou(t2).Xo && await async function(t3, e2) {
    if (n = e2.code, Zn(n) && n !== B2.ABORTED) {
      ...
      Ou(t3).Fo(), await Eu(t3, () => t3.remoteSyncer.rejectFailedWrite(n2.batchId, e2)), await Au(t3);
    }
    var n;
  }(t2, e), Pu(t2) && vu(t2);
}
async function xu(t2, e) {
  ...
  const s = mu(n);
  n.wu.add(3), await au(n), s && n.yu.set("Unknown"), await n.remoteSyncer.handleCredentialChange(e), n.wu.delete(3), await cu(n);
}
async function Nu(t2, e) {
  const n = $(t2);
  e ? (n.wu.delete(2), await cu(n)) : e || (n.wu.add(2), await au(n), n.yu.set("Unknown"));
}
function ku(t2) {
...
function Ou(t2) {
  return t2.Tu || (t2.Tu = function(t3, e, n) {
    ...
    e ? (t2.Tu.Fo(), await Au(t2)) : (await t2.Tu.stop(), t2.du.length > 0 && (C2("RemoteStore", `Stopping write stream with ${t2.du.length} pending writes`), t2.du = []));
  })), t2.Tu;
}
var Mu = class {
  constructor(t2, e, n, s, i) {
...
var Bu = class {
  ...
  track(t2) {
    ...
    n ? 0 !== t2.type && 3 === n.type ? this.Eu = this.Eu.insert(e, t2) : 3 === t2.type && 1 !== n.type ? this.Eu = this.Eu.insert(e, {
      type: n.type,
      doc: t2.doc
    }) : 2 === t2.type && 2 === n.type ? this.Eu = this.Eu.insert(e, {
      type: 2,
      doc: t2.doc
    }) : 2 === t2.type && 0 === n.type ? this.Eu = this.Eu.insert(e, {
      type: 0,
      doc: t2.doc
    }) : 1 === t2.type && 0 === n.type ? this.Eu = this.Eu.remove(e) : 1 === t2.type && 2 === n.type ? this.Eu = this.Eu.insert(e, {
      type: 1,
      doc: n.doc
    }) : 0 === t2.type && 1 === n.type ? this.Eu = this.Eu.insert(e, {
      type: 2,
      doc: t2.doc
    }) : O2() : this.Eu = this.Eu.insert(e, t2);
  }
  Au() {
    const t2 = [];
...
var zu = class {
  ...
  xu(t2, e) {
    if (!t2.fromCache)
      return true;
    const n = "Offline" !== e;
    return (!this.options.ku || !n) && (!t2.docs.isEmpty() || t2.hasCachedResults || "Offline" === e);
  }
  Cu(t2) {
...
var Yu = class {
  ...
  Fu(t2) {
    ...
    if (t2.payload.namedQuery)
      ...
      const n = rt.fromString(t2.payload.documentMetadata.name);
...
function kc2(t2) {
  const e = $(t2);
  return e.remoteStore.remoteSyncer.applyRemoteEvent = ac2.bind(null, e), e.remoteStore.remoteSyncer.getRemoteKeysForTarget = Rc2.bind(null, e), e.remoteStore.remoteSyncer.rejectListen = lc2.bind(null, e), e.sc.zo = Qu.bind(null, e.eventManager), e.sc.wc = ju.bind(null, e.eventManager), e;
}
function Oc2(t2) {
  const e = $(t2);
...
var Lc2 = class {
  ...
  terminate() {
    return async function(t2) {
      const e = $(t2);
      C2("RemoteStore", "RemoteStore shutting down."), e.wu.add(5), await au(e), e.gu.shutdown(), e.yu.set("Unknown");
    }(this.remoteStore);
  }
};
function Uc2(t2, e, n) {
...
var da2 = class {
  constructor(t2, e, n, s, i) {
    this.asyncQueue = t2, this.datastore = e, this.options = n, this.updateFunction = s, this.deferred = i, this.kc = n.maxAttempts, this.No = new tu(this.asyncQueue, "transaction_retry");
  }
  run() {
    this.kc -= 1, this.Oc();
  }
...
var ka2 = class {
  constructor() {
    this.Bc = Promise.resolve(), this.Lc = [], this.Uc = false, this.qc = [], this.Kc = null, this.Gc = false, this.Qc = false, this.jc = [], this.No = new tu(this, "async_queue_retry"), this.Wc = () => {
      const t3 = Xo();
      t3 && C2("AsyncQueue", "Visibility state changed to " + t3.visibilityState), this.No.Po();
    };
    const t2 = Xo();
...
var $a2 = class extends Jc2 {
  constructor(t2, e, n, s) {
    super(t2, e, n, s), this.type = "firestore", this._queue = new ka2(), this._persistenceKey = (null == s ? void 0 : s.name) || "[DEFAULT]";
  }
  _terminate() {
    ...
    return this._cachedChanges && this._cachedChangesIncludeMetadataChanges === e || (this._cachedChanges = function(t3, e2) {
      if (t3._snapshot.oldDocs.isEmpty()) {
        ...
        return t3._snapshot.docChanges.map((n) => ({
          type: "added",
          doc: new rl(t3._firestore, t3._userDataWriter, n.doc.key, n.doc, new sl(t3._snapshot.mutatedKeys.has(n.doc.key), t3._snapshot.fromCache), t3.query.converter),
          oldIndex: -1,
          newIndex: e3++
        }));
      }
...
!function(t2, e = true) {
  ...
  }, "PUBLIC").setMultipleInstances(true)), registerVersion(b, "3.7.1", t2), registerVersion(b, "3.7.1", "esm2017");
}();
export {
